...
export const PEAQ_MAINNET: PeaqNetworkConfig = {
  ...
  ss58Prefix: 42,
  // quicknode is primary; publicnode + onfinality are documented fallbacks.
  // Source: docs.peaq.xyz/peaqchain/build/getting-started/connecting-to-peaq (checked 2026-05-16).
  endpoints: {
    httpsRpc: [
    ...
    blockExplorer: ["https://peaq.subscan.io", "https://peaqscan.xyz", "https://scout.peaq.xyz"],
  },
  paraId: 3338,
};
...
export const PEAQ_AGUNG: PeaqNetworkConfig = {
  ...
  ss58Prefix: 42,
  endpoints: {
    httpsRpc: ["https://peaq-agung.api.onfinality.io/public", "https://wss-async-agung.peaq.xyz"],
    wssRpc: ["wss://peaq-agung.api.onfinality.io/public-ws", "wss://wss-async-agung.peaq.xyz"],
    blockExplorer: ["https://agung-testnet.subscan.io", "https://testnet.peaqscan.xyz"],
  },
  paraId: null,
};
